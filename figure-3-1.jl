...
experiments = RawExperiment(Pyolin.search("KT2440", "pSeva221", "Lmra_n1"))
...
plot!(rawplt, xlims=(0, 85))

experiments = RPUExperiment(Pyolin.search("KT2440", "pSeva221", "Lmra_n1"))
rpuplt = plot(;xlabel="YFP (RPU)", ylabel="Frequency Density", opts...)
